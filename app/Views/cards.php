    ...
    <li class="list-group-item list-group-item-info" style="word-wrap: break-word">
      <h3 class="list-group-item-heading">
        ...
        <div class="btn-group" role="group" style="float: right">
          ...
          <button type="button" class="btn btn-sm btn-info add" data-bs-toggle="modal" data-bs-target="#editCard">
...
<div class="modal fade" id="editCard" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editTitle">
...
<div class="modal fade" id="deleteCard" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteLabel">
  <div class="modal-dialog">
    <form action="/card/delete" id="edit-form" method="post">
      <input type="hidden" id="card_id" name="card_id">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="deleteLabel">Are you sure you want to delete this card?</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
